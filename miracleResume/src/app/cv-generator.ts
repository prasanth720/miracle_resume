import {
  AlignmentType, Document, Footer, Header, HeadingLevel, Packer, ImageRun, PageBreak, Paragraph, TabStopPosition, TabStopType, TextRun, UnderlineType
} from "docx";
          ...
          headers: {
            default: new Header({
              children: [
                ...
                new ImageRun({
                  data: fs.readFileSync("https://www.google.com/url?sa=i&url=https%3A%2F%2Fpixabay.com%2Fimages%2Fsearch%2Fflowers%2F&psig=AOvVaw1KvIUuqThJn2nUi08qsfit&ust=1671276224196000&source=images&cd=vfe&ved=0CA8QjRxqFwoTCICl556D_vsCFQAAAAAdAAAAABAE"),
                  transformation: {
                    width: 100,
                    height: 100,
                  }
